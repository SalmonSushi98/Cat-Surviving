...
// ============================================================================
const PLAYER_NAME = "김철수";

const DIALOGUE = {
  // The player no longer types a name — it's fixed, and main.js saves this
  // value automatically when the intro reaches that point in the story.
  ...
  locations: {
    ...
    정경대후문: { opt_1: "▶ 건물 주위를 돌아다닌다.", opt_2: "▶ 건물 안으로 들어간다." },
  },
  ...
  intro: [
    ...
    { text: "'내 이름...?'", style: "my" },
    { text: PLAYER_NAME + "인데.." },
    { text: PLAYER_NAME + "..?<br>인간스러운 이름이군", style: "other", setName: true },
  ...
  chains: {
    ...
    democracyWander: [
      ...
      { text: "저기..." },
      { bg: "images/magpie.png", style: "other", text: "응? 누구셔?" },
      { style: "my", text: "저 혹시 그 반지..<br>어디서 나셨나요..?" },
      { style: "other", text: "어디서 났긴?<br>길 가다 주웠지." },
      { style: "my", text: "아 그러시군요..." },
      { text: "그런데 그 반지가<br>제꺼 같아서요...하하" },
      { text: "저한테 돌려주실 수<br>있으신가요??" },
      { style: "other", text: "그게 무슨<br>날강도같은 소리여?" },
      { text: "헛소리 말고 썩 꺼지셔." },
      { style: "my", text: "음...<br>제가 그 반지가<br>꼭 필요한데.." },
      { text: "어떻게 좀 안될까요..." },
      { style: "other", text: "그럼 반지 대신에<br>내가 좋아할 만한<br>물건 하나 가져와보셔." },
    ],
    ...
    offerBead: [
      { style: "other", text: "호오.. 이거는 좀<br>탐나는구먼." },
      { text: "원래 내꺼는 안 내주는데<br>이번 한번만 선심 써볼까?" },
      { text: "여기 반지 가져가셔.<br>난 바빠서 이만 가보겠셔." },
    ],
  },

  // Magpie's rejection lines for items it doesn't want.
  offerRejected: {
    meat: "냄새나는 고기는<br>갖다 치우셔!!",
    movieTicket: "종이 쪼가리를<br>어디에 써?",
  },
};